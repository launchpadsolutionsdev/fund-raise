...
- crm_gifts: Core gift records (gift_id, gift_amount, gift_code, gift_date, gift_status, gift_payment_type, gift_acknowledge, gift_acknowledge_date, gift_receipt_amount, gift_batch_number, gift_date_added, gift_date_last_changed, system_record_id, constituent_id, first_name, last_name, fund_category, fund_description, fund_id, fund_notes, campaign_id, campaign_description, campaign_notes, campaign_start_date, campaign_end_date, appeal_category, appeal_description, appeal_id, appeal_notes, appeal_start_date, appeal_end_date, tenant_id)
